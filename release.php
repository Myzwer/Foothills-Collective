...
<div class="grid grid-cols-12">
           ...
           <h2 class="text-center pt-5 text-3xl font-bold"><?php the_field('title'); ?></h2>
                <h2 class="text-center pt-2"><span class="pr-1"><?php the_field('location_icon'); ?></span><?php the_field('subtitle'); ?></h2>
                <h2 class="text-center xl:mx-64 md:mx-40 lg:mx-32 pt-3"><?php the_field('info'); ?></h2>


                <div class="text-center pt-5">
                    <a class="bg-black md:p-5 p-3 rounded-full text-white" href="#"><?php the_field('icons'); ?></a>
                </div>
                    ...
                    <div class="bg-white col-span-12 md:col-span-3 lg:col-span-3 rounded-lg p-4 pt-5 pb-5 md:p-0">
                        <a href="#"><div class="grid grid-cols-12 transition duration-300 ease-in-out hover-text">
                            <div class="col-span-3 md:col-span-12 md:-mt-6">
                                <img src="<?php the_sub_field('social_media_logo'); ?>" class="text-6xl inline md:block md:mx-auto ytred w-14">
                            </div>

                            <div class="col-span-9 md:col-span-12">
                                <h2 class="md:text-center text-sm text-gray hidden md:block md:pt-4"><?php the_sub_field('social_title'); ?></h2>
                                <h2 class="md:text-center pt-1 uppercase mx-1 text-sm font-bold col-span-8 md:pb-3 md:pt-5"><?php the_sub_field('song'); ?></h2>
                                <h2 class="md:text-center uppercase mx-1 text-sm font-bold hidden md:block md:pb-3"><?php the_sub_field('decoration'); ?></h2>
                                <h2 class="md:text-center md:mx-4 mx-1 text-xs col-span-8 md:pb-8"><?php the_sub_field('social_info'); ?></h2>
                            </div>
                        </div>
                        </a>
                    </div>
